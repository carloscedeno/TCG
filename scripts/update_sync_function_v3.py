...
AS $function$
 ...
 BEGIN
     IF (TG_TABLE_NAME = 'products') THEN
         ...
         SELECT 
             ...
             COALESCE(s.release_date, NEW.release_date) -- FIXED: release_date is in sets table (s)
         INTO 
 ...
 $function$;
"""
        print("Actualizando funcioin sync_product_metadata (V3 - Release date fix)...")
        cur.execute(sql)
        conn.commit()
