-- Emergency Fix: Optimize get_products_filtered and unify pricing source of truth
-- Resolves production timeouts (500) and stale $11.99 prices

BEGIN;

-- 1. Update get_products_filtered to be high-performance and use denormalized prices
...
-- 2. Sync the Products price column to avoid any ambiguity (optional reinforcement)
UPDATE public.products p
SET price = cp.avg_market_price_usd
