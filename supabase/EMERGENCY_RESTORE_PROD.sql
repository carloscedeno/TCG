-- =============================================================================
-- EMERGENCIA: RESTAURACIÓN DE PRODUCCIÓN (MOTOR DE BÚSQUEDA)
-- =============================================================================
-- Ejecuta este script INMEDIATAMENTE en el SQL Editor de tu proyecto de PRODUCCIÓN
-- Esto restaurará la vista materializada y las funciones RPC que se borraron
-- y hará que las cartas vuelvan a aparecer en la tienda.
-- =============================================================================

BEGIN;

-- 1. RECREAR LA VISTA MATERIALIZADA (El núcleo de la tienda)
...
-- 2. RESTAURAR LOS ÍNDICES PARA RENDIMIENTO
...
-- 3. RECREAR EL RPC PRINCIPAL DE BÚSQUEDA
