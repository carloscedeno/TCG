...
- **Ampliaci�n de Esquema**: A�adida columna dditional_images (text[]) a accesorios con soporte en RPCs.
- **Admin UI**: Implementado sistema de carga m�ltiple con previsualizaci�n y selecci�n de imagen principal.
- **Carousel Din�mico**: Integrado visor premium en CardModal con soporte para swipe, navegaci�n por puntos y transiciones de desenfoque suaves.
- **Optimizaci�n de Datos**: Se mantiene la imagen principal fuera del array para compatibilidad y performance en grids.
