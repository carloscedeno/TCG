...
def update_rpcs():
    ...
    # 1. Update get_inventory_list
    sql_inventory = """
DROP FUNCTION IF EXISTS get_inventory_list(INTEGER, INTEGER, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS get_inventory_list(INTEGER, INTEGER, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN);
...
"""
    ...
    # 2. Update get_products_filtered
    sql_products = """
CREATE OR REPLACE FUNCTION public.get_products_filtered(
    ...
    p_only_new boolean DEFAULT false -- New Param
)
RETURNS TABLE (
    id uuid,
    name text,
    ...
    set_name text,
    finish text,
    updated_at timestamptz -- Include updated_at
) AS $$
            DECLARE
              v_game_code TEXT;
              v_sort_by TEXT;
            ...
            BEGIN
              ...
              ORDER BY
                -- If New Filter is active, prioritize updated_at
                ...
                -- Release date sort stays for explicit release_date sort
...
"""
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            conn.commit()
            print("Successfully updated RPCs: get_inventory_list, get_products_filtered")
        conn.close()
