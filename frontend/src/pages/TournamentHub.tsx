...
const TournamentHub: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-geeko-black text-white font-sans relative selection:bg-geeko-cyan-neon/30">
            {/* Ambient Background Mesh */}
            <div className="fixed inset-0 z-0 pointer-events-none">
                <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-geeko-cyan-neon/5 rounded-full blur-[120px]" />
                ...
                <main className="flex-1 max-w-[1600px] mx-auto w-full px-6 py-12 space-y-12">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-white/5 pb-12">
                        <div className="space-y-4">
                            <h2 className="text-xs font-black text-geeko-cyan-neon uppercase tracking-[0.4em]">Próximas Misiones</h2>
                            <h1 className="text-5xl md:text-7xl font-black text-white italic tracking-tighter uppercase leading-[0.85]">
                                Geekorium <br /><span className="neon-text-cyan">Arena</span>
                            </h1>
                        ...
                        <div className="flex gap-4">
                            ...
                            >
                                <Users size={16} className="group-hover:text-geeko-cyan-neon transition-colors" /> Mi Perfil de Jugador
                            </button>
                        </div>
                    </div>
                            ...
                            {loading ? (
                                ...
                                events.map((tournament) => {
                                    ...
                                    return (
                                        <div 
                                            key={tournament.id} 
                                            className={`group rounded-3xl overflow-hidden bg-white/[0.02] border border-white/5 hover:border-geeko-cyan-neon/30 transition-all hover:scale-[1.02] duration-500`}
                                        >
                                            ...
                                            <div className="p-8 space-y-6">
                                                <div>
                                                    <h3 className="text-2xl font-black italic tracking-tighter uppercase line-clamp-2 group-hover:text-geeko-cyan-neon transition-colors duration-300">
                                                        {tournament.name}
                                                    </h3>
                                                    <div className="flex items-center gap-3 text-neutral-500 text-[10px] font-black uppercase tracking-widest mt-3">
                                                        <Calendar size={14} className="text-geeko-cyan-neon" />
                                                ...
                                                <div className="flex items-center justify-between gap-4">
                                                    ...
                                                    <button 
                                                        ...
                                                        className="flex-1 bg-geeko-cyan-neon hover:bg-white text-black px-6 py-4 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all transform active:scale-95 shadow-lg shadow-geeko-cyan-neon/10"
                                                    >
                                                        Pre-inscribirme
                                                    </button>
                                                </div>
