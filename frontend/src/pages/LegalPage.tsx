        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-cyan-500/30">
            ...
            <main className="relative z-10 max-w-4xl mx-auto px-6 py-12 lg:py-20">
                ...
                <div className="flex justify-center mt-20">
                    <img src="/branding/Logo.png" alt="Logo" className="w-16 h-16 rounded-full opacity-20 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700" />
                </div>
