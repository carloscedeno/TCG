...
function generateOrderReceiptHTML(order: Order) {
    ...
    const itemRows = (order.order_items || []).map(item => {
        ...
        const itemCode = item.product ? `<span style="color:#9ca3af;font-size:11px;margin-left:6px;">(${item.product.set_code.toUpperCase()} - ${item.product.collector_number || ''})</span>` : '';
        return `<tr>
...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .bar { width:48px; height:4px; background:#0066FF; border-radius:2px; margin:10px auto 0; }
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center mb-4">
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#0066FF]/10 border border-[#0066FF]/30 text-[#0066FF] hover:bg-[#0066FF]/20 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all"
                                                >
