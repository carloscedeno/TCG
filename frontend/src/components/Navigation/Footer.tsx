            ...
            <div className="max-w-[1600px] mx-auto px-6 grid grid-cols-1 md:grid-cols-3 items-center gap-12 text-center md:text-left">
                <div className="flex flex-col gap-6 justify-center md:justify-start">
                    ...
                    <div className="flex flex-col gap-3 text-sm font-medium text-text-low">
                        <a href="https://wa.me/584242507802" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">WhatsApp Atención Principal: +58 424-2507802</a>
                    ...
                    <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6">
                        ...
                        <a href="https://www.tiktok.com/@geekorium" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-text-low hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=61573984506104" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-text-low hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                        </a>
                        <a href="https://discord.gg/wmYhWw5Q" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-text-low hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="https://www.youtube.com/@Geekorium" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-text-low hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="https://www.twitch.tv/geekorium" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-text-low hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="mailto:info@geekorium.shop" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-text-low hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>
                        </a>
                    </div>
                </div>
                <div className="text-text-low text-xs font-medium text-center">
