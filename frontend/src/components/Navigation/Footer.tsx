            ...
            <div className="max-w-[1600px] mx-auto px-6 grid grid-cols-1 md:grid-cols-3 items-center gap-12 text-center md:text-left">
                <div className="flex flex-col gap-6 justify-center md:justify-start">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6">
                        <a href="https://instagram.com/geekorium/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-500 hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="https://www.tiktok.com/@geekorium" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-500 hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=61573984506104" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-500 hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                        </a>
                        <a href="https://discord.gg/wmYhWw5Q" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-500 hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="https://www.youtube.com/@Geekorium" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-500 hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="https://www.twitch.tv/geekorium" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-500 hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
                        ...
                        <a href="mailto:info@geekorium.shop" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-500 hover:bg-white hover:text-black transition-all shadow-lg hover:shadow-white/20">
