                                                ...
                                                return (
                                                    <tr key={i} className={`transition-colors ${isErr ? 'bg-red-500/5 hover:bg-red-500/10' : 'hover:bg-white/5'}`}>
                                                        ...
                                                        <td className="p-3 text-center">
                                                            ...
                                                            {row.status === 'ok' && <span className="text-white font-black uppercase tracking-wider">OK</span>}
                                                        </td>
                        ...
                        <GlassCard className="p-16 text-center space-y-8 animate-in zoom-in-95">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400 font-bold">
                                    Se egresaron <span className="text-white">{result?.egress_count || 0}</span> nodos de cartas. 
                                </p>
