...
- **Causa RaÃ­z**: 
  1. El sistema de sincronizaciÃ³n estaba fragmentado en 3 scripts distintos, lo que causaba carreras de datos.
...
- **LecciÃ³n**: 
  - **UnificaciÃ³n de OrquestaciÃ³n**: Utilizar un Ãºnico script maestro (`omni_sync.py`) para todos los TCGs garantiza coherencia en los logs y el estado de la DB.
  - **Prioridad de Precios Retail**: Para MTG en CardKingdom, el campo `price_retail` es el Ãºnico que garantiza el precio de venta real Near Mint.
  ...
  - **Soporte Nativo de Precios TCGPlayer**: Los loaders de metadatos (como el de Pokemon) deben configurarse para extraer tambiÃ©n los precios en el mismo paso para evitar productos con stock pero sin valor.

### 105. CentralizaciÃ³n de Mapeos de Negocio en Frontend â€” 2026-04-26
- **Problema:** Filtrado inconsistente donde PokÃ©mon mostraba Digimon.
- **Causa RaÃ­z:** Mapeos de cÃ³digos a nombres dispersos y desincronizados entre componentes.
