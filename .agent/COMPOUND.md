...
## 2026-04-26 � Expansi�n Omni-TCG y Resoluci�n de Ambig�edad

**Qu� pas�:** Se implement� la base t�cnica para soportar m�ltiples TCGs (Pok�mon, One Piece, etc.) con validaci�n din�mica. Se resolvieron errores cr�ticos de duplicaci�n de juegos y ambig�edad de funciones en Supabase.
**Lo que cambi�:**
- lessons_learned.md ? Lecciones 103, 104, 105.
- AGENTS.md ? Features v1.0 y reglas de estandarizaci�n.
- rontend/src/pages/Home.tsx ? Mapeos centralizados.
- rontend/src/components/Navigation/Header.tsx ? Navegaci�n Omni-TCG.
**Artefacto creado:** Bloque PL/pgSQL de limpieza de OIDs para RPCs.
**Regla derivada:** Ley 26 de Estandarizaci�n de C�digos (3 letras).

## 2026-04-27 - Filtrado Estricto de Productos por Juego

**Qué pasó:** Se implementó el filtrado estricto en la sección de Productos para evitar que ítems genéricos (game_id NULL) contaminen la vista cuando se selecciona un juego específico (MTG).
**Lo que cambió:**
- lessons_learned.md -> Lección #106
...
**Regla derivada:** Los catálogos polimórficos deben usar filtrado estricto de juego para mantener la relevancia de nicho.

## 2026-04-27 ?" Unificacin de Cdigos Omni-TCG y Estabilizacin de Produccin

**Qu pas�:** Se detect� una inconsistencia cr�tica en el guardado de nuevos productos (Pok�mon/One Piece) que los hac�a invisibles en la tienda. Se estabiliz� el motor de precios y se unificaron los c�digos de juego en toda la infraestructura de producci�n.
**Lo que cambi�:**
- lessons_learned.md ?" Lecci�n #107 (Estandarizaci�n de c�digos).
- LEYES_DEL_SISTEMA.md ?" Leyes 15 y 16 (Est�ndares y Protecci�n de Entornos).
- AGENTS.md ?" Actualizaci�n de tareas implementadas.
- RPC upsert_product_inventory ?" Ahora mapea autom�ticamente a c�digos cortos (MTG, PKM, OPC).
