...
- **✅ Corrección de Branding y Contacto**: Sustitución del nombre en texto por el logo circular oficial en Header, Footer y WelcomeModal. Restauración del enlace `mailto` directo a `info@geekorium.shop` eliminando redirecciones obsoletas a Mailchimp. Sincronización de assets oficiales y eliminación de badges "DEV" hardcodeados.
